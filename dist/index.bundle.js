...
var vcHome = function vcHome(resolve) {
  return __webpack_require__.e/* import() */(2).then(__webpack_require__.bind(null, 7)).then(resolve);
};
var vcIconCategory = function vcIconCategory(resolve) {
  return __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 8)).then(resolve);
};
var vcFavorites = function vcFavorites(resolve) {
  return __webpack_require__.e/* import() */(1).then(__webpack_require__.bind(null, 9)).then(resolve);
};
